...
Impromptu's the separation of components also allows several musicians to collaborate at the same time in a performance\cite{sorensen2005impromptu}.
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\linewidth]{./\figurePath/lt_game_example__inv}
...
%\begin{figure}
%  \centering
%  \includegraphics[width=12cm]{./\figurePath/lt_clojure_table__inv}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=1.0\linewidth]{./\figurePath/lt_val_overlay__inv}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.8\linewidth]{\figurePath/ds_autocad}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.8\linewidth]{\figurePath/ds_dsstudio}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.8\linewidth]{\figurePath/ds_dynamo}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{\figurePath/antimony_ui_handles}
...
% as seen in Table~\ref{table:general:comp},
...
%(``text'' in Table~\ref{table:edit:prog:paradigms})
%(``++text'' in Table~\ref{table:edit:prog:paradigms})
