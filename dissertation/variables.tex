...
\newcommand {\Supervisors} {{\large Prof. António Paulo Teles de Menezes Correia Leitão}}
...
\newcommand {\Advisor} {{\large Prof. António Paulo Teles de Menezes Correia Leitão}}
\newcommand {\CoAdvisor} {{\large Prof./Dr. Co Advisor}}

% After the thesis defense
\newcommand {\CommitteeMembers} {
{\large Prof. Daniel Jorge Viegas Gonçalves}%\\
%{\large Prof./Dr. Lorem Ipsum}
}
\newcommand {\Chairperson} {{\large Prof. Alberto Manuel Rodrigues da Silva}}
