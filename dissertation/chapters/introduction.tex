...
This has allowed \gls{cad} software to be used to create visualizations and documentation for architectural projects.
...
This will require the environment to run programs fast, generate results, and display them to give the architect, thus giving immediate feedback.
