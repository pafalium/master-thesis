...
Following the presentation and comparison of those environments, we described our solution in Chapter~\ref{chapter:solution}.
...
Additionally, we tested the solution's performance by measuring the program running and export times on the web page and comparing them to running times on Rosetta.
