...
Collaboration is only directly supported in Impromptu, Clara.io and OnShape which allow for real-time collaboration enabling their users to work on the same artifact simultaneously --- i.e. Impromptu's runtime, a Clara.io scene or a OnShape model.
