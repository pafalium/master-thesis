...
To make the editing experience more intuitive, it runs programs when they are changed, allows numeric literals to be adjusted by clicking and dragging, and highlights the relationship between program and results.
...
In addition, in what concerns program running times, it has good performance that can be ten times faster than current GD IDEs.
