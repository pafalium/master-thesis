...
Architects would benefit from a GD Integrated Development Environment (IDE) in the web that is accessible without installation, and, on the other hand, is at least as interactive as existing GD environments.
...
In addition, with respect to program running times, it has good performance that can be ten times faster than current GD IDEs.
