...
Desenho Generativo (DG) permite aos arquitetos explorar novos tipos de design usando uma abordagem baseada na programação.
Os ambientes de DG atuais baseiam-se nas aplicações de \foreign{Computer-Aided Design} (CAD) existentes, como o \foreign{AutoCAD} e o \foreign{Rhinoceros 3D}, que, devido à sua complexidade, são lentos e não dão o \foreign{feedback} necessário para que os arquitetos explorem o DG.
...
Seria vantajoso para os arquitetos ter um Ambiente de Desenvolvimento Integrado (IDE em inglês) para DG na \foreign{web}, acessível em qualquer computador sem instalação e pelo menos tão interactivo como os ambientes para DG existentes.
